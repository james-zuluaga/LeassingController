...
let tPersonas=0;// se opera
 ...
 function sumaAc201(){
   ...
   subsidioRes=Number(document.getElementById(`pal11`).value);
   cargofiNores=Number(document.getElementById(`pal12`).value);
   aporte=Number(document.getElementById(`pal13`).value);
     toAseo=Number(document.getElementById(`pal14`).value);
     tPersonas=Number(document.getElementById(`pal15`).value);
     personasxapto=Number(document.getElementById(`pal16`).value);
   ...
   consumo301= resultado301*vrKwSin301;
      document.getElementById('valAcuXPer').textContent = 'los Kw consumidos son : ' + valAcuXPer;
      document.getElementById('valAcuXPer').textContent = 'el valor a pagar es: ' + valAcuXPer;
      document.getElementById('valAcuXPer').textContent = 'el valor del kw con subsidio es: $' + valAcuXPer;
 }
